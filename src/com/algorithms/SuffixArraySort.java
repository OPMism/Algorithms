...
public class SuffixArraySort {
	...
	public SuffixArraySort(String str) {
		int i;
		int level;
		int skip;
		L = str.length();
	...
	public static void main(String[] args) {
		...
		PrintWriter out;
		SuffixArraySort suffixArraySort;
		MaximumLCP ans;
		...
		suffixArraySort = new SuffixArraySort(str);
		 ...
		 * "," + j + "): " + suffixArraySort.lcp(i, j));
		 */
		ans = suffixArraySort.buildLCPArray(strBLen);
